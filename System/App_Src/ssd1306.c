...
/**
  ***************************************************************************************************************************************
  * @brief  SSD1306 get init state
  * @param  None
  * @retval State (uint8_t)
  ***************************************************************************************************************************************
  */
uint8_t SSD1306_Get_Init_State(void)
{
...
{
	/* Go through font */
	for(int16_t _i=0U;_i<_font->fontHeight;_i++)
	{
		int16_t _b=_font->data[(_ch-32U)*_font->fontHeight+_i];

		for(int16_t _j=0U;_j<_font->fontWidth;_j++)
		{
